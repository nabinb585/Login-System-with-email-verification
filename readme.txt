...
* Functionality for:
  * Secure Register with form validation, captcha, password strength and email verification
...
### DEMO
http://localhost/neww/login-user.php

#Note: under htdocs i have created neww folder